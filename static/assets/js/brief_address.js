        ...
        success: function (data) {
            if (data.errcode == 0) {
                ...
                for (let i = 0; i < obj.length; i++) {
                    var tou = $("<div class=' bor_bot pods'></div>");
                    ...
                    $(`<div class='ris'>
                       ...
                       <label for='paixu${i}' >设为默认地址</label>
                        ...
                        var check = $(this).parent().parent().find("input:eq(1)");
                    ...
                    //选择地址
                    $(`<div class="ress_towDiv">使用</div>`).click(function () {
                        var id = $(this).parent().parent().find("input:eq(0)").val();
                        if (gooid && qnum) {
                            location.href = `order?id=${id}&goodsId=${gooid}&quantity=${qnum}`
                        } else {
                    ...
                    ress.appendTo(tou);
                    tou.appendTo(dv);
                    $(`<div class="row bar"></div>`).appendTo(dv);
                    shio();
                }
            } else {
                showTip(data.message);
...
function shio() {
    ...
    $("input[value='1']").parent().parent().parent().css("backgroundColor", '#F0F0F0')
}
